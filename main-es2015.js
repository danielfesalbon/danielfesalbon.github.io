...
class AppComponent {
    ...
    spawnNightStar(night) {
        ...
        let x = Math.floor(Math.random() * night.offsetWidth);
        let y = Math.floor(Math.random() * (night.offsetHeight - 300));
        div.style.left = x + 'px';
        div.style.top = y + 'px';
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], hostBindings: function AppComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 24, vars: 2, consts: [[1, "layout"], ["id", "space", 1, "sliding"], [1, "me"], [1, "im"], [1, "name"], ["id", "div2"], [1, "navbar"], ["href", "#space", 4, "ngIf"], ["href", "#horizon", 4, "ngIf"], ["id", "horizon"], ["id", "nightsky", 1, "nightsky"], [1, "me", "white"], [2, "height", "500px", "position", "relative"], [1, "wave", 2, "animation", "waves 6s linear infinite", "opacity", "1", "z-index", "10"], [1, "wave", 2, "animation", "waves 10s linear infinite", "opacity", ".75", "z-index", "11"], [1, "wave", 2, "animation", "waves 3s linear infinite", "opacity", ".5", "z-index", "12"], [1, "sea"], [1, "footer"], ["href", "#space"], ["href", "#horizon"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
