...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function spawnNightStar(night) {
          ...
          div.classList.add("nightstar"); //let scale = night.offsetWidth / night.offsetHeight;

          var scale = window.innerWidth / window.innerHeight;
          var x = Math.floor(Math.random() * window.innerWidth);
          var yratio = window.innerWidth / scale;
          var y = Math.floor(Math.random() * (yratio / 2));
          div.style.left = x + 'px';
          div.style.top = y + 'px';
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 24,
      vars: 2,
      consts: [[1, "layout"], ["id", "space", 1, "sliding"], [1, "me"], [1, "im"], [1, "name"], ["id", "div2"], [1, "navbar"], ["href", "#space", 4, "ngIf"], ["href", "#horizon", 4, "ngIf"], ["id", "horizon"], ["id", "nightsky", 1, "nightsky"], [1, "me", "white"], [1, "wave-wrapper"], [1, "wave", 2, "animation", "waves 6s linear infinite", "opacity", "1", "z-index", "10"], [1, "wave", 2, "animation", "waves 10s linear infinite", "opacity", ".75", "z-index", "11"], [1, "wave", 2, "animation", "waves 3s linear infinite", "opacity", ".5", "z-index", "12"], [1, "sea"], [1, "footer"], ["href", "#space"], ["href", "#horizon"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](15, "and I'm wondering how did you get here.");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](23, "2020, Daniel Fesalbon");
